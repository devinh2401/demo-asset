                ...
                <div className="panel">
                    ...
                    <div className="panel-info">
                        <div className='panel-list'>
                            ...
                            <button className="btn-primary" data-bs-toggle="modal" data-bs-target="#formsp" style={{textTransform:'uppercase' , borderRadius:'3px', padding:'2px', marginLeft:'3px'}}> lịch sử sửa chữa tài sản</button>
